...
#/share/apache_log_analyzer.rb

#less /var/log/apache2/access.log
#/share/apache_log_analyzer.rb /var/log/apache2/access.log
...
# IP: 10.0.0.2, Total Hits: 3016, Secret Hits: 1508
# IP: 10.0.0.3, Total Hits: 3081, Secret Hits: 1027
# IP: 10.0.0.4, Total Hits: 3256, Secret Hits: 814
# IP: 10.0.0.5, Total Hits: 3625, Secret Hits: 725
# IP: 10.0.0.6, Total Hits: 4296, Secret Hits: 716
# IP: 31.184.194.10, Total Hits: 1, Secret Hits: 0
# ./apache_log_analyzer.rb:88:in `sort': comparison of Array with Array failed (ArgumentError)
#         from ./apache_log_analyzer.rb:88:in `print_hits'
#         from ./apache_log_analyzer.rb:56:in `analyze'
#         from ./apache_log_analyzer.rb:110:in `block in main'
#         from ./apache_log_analyzer.rb:108:in `each'
#         from ./apache_log_analyzer.rb:108:in `main'
#         from ./apache_log_analyzer.rb:116:in `<main>'
